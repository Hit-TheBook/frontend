              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // 연기 버튼
                    _buildIconButton(Icons.close, Colors.red, '안함', 'FAILED', context, 80.w), // 너비 설정
                    _buildIconButton(Icons.arrow_forward, Colors.yellow, '다음에', 'POSTPONED', context, 80.w), // 너비 설정
                  ],
                ),
              ),
            ),
