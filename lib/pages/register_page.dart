            ...
            children: [
                  ...
                  const Expanded(
                    child: TextField(
                      decoration: InputDecoration(
                        fillColor: Color(0xFF333333), // 텍스트 필드 배경색 변경
                        filled: true, // 배경색 적용
              ...
              Row(
                children: [
                  ...
                  const Spacer(), // 텍스트 필드와 버튼 사이의 공간 채움
                  ElevatedButton(
                    onPressed: () {
                      // 버튼 클릭 시 동작 추가
                    },
              ...
              const SizedBox(height: 8), // 텍스트 필드와 안내 문구 사이의 간격
              Text(
                '* 8자리 이상 영어 대소문자, 숫자, 특수문자 중 2종류 이상을 조합해야 합니다.',
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  color: white1, // 작은 회색 텍스트로 표시
                ),
              ),
              ...
              const SizedBox(height: 16), // 사용자 이름 입력 필드와 이전 필드 사이의 간격
              Text(
                '사용자 이름 입력',
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                  fontWeight: FontWeight.bold,
